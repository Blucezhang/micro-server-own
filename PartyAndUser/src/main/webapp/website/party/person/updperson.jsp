...
<div class="modal fade" id="updPersonId" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="text-align: center;">
				<form name="emForm" action="" method="post" id="form" enctype="application/x-www-form-urlencoded">
					<div class="form-horizontal" style="margin-top: 10px;">
						<ul>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<select class="form-control" ng-model="personData.orgId" readOnly>
					...
					<input class="btn btn-primary" style="margin-left: 20px;" type="button" value="修改" ng-click="upd();">
					<input class="btn btn-primary" style="margin-left: 20px;" type="button" value="返回" ng-click="closeUpd();">
			 </form>
		   </div>			
		</div>
	</div>
