...
<body class="container" >
	<ol class="breadcrumb">
		...
		<li style="font-size: 13px">产品</li>
		<li style="font-size: 13px">类别</li>
	</ol>
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
					   ...
					   <div class="col-xs-3" style="margin-left: 225px;margin-top:-18px;">
							<input type="button" id="searchBtnId" class="btn btn-primary" ng-click="testA();" value="查询" />
					   </div>
				    </div> 
			</div>
	...
	<div ng-include src="'/website/product/category/addcategory.jsp'"></div>
	<div ng-include src="'/website/product/category/updcategory.jsp'"></div> 
